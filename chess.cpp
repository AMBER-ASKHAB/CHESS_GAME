...
//void tossing()
//{
//    wstring player1, player2;
//   	wcout << "\n\n\n\t\t   _____ _    _ ______  _____ _____ \n\t\t  / ____| |  | |  ____|/ ____/ ____| \n\t\t | |    | |__| | |__  | (___| (___  \n\t\t | |    |  __  |  __|  \\___  \\___ \\ \n\t\t | |____| |  | | |____ ____) |___) | \n\t\t  \\_____|_|  |_|______|_____/_____/ \n" << endl;
//    wcout << "\t\t\t     Amber Askhab(BSCS-I)\n\n" << endl;
//    //wstring player_one=L"White", player_two=L"Black";
//   
//   // drawBoard(player_one, player_two);
//    wcout << "\t\t   Enter Name Of Player 1 ";
//    wcin >> player1;
//    wcout << "\t\t   Enter Name Of Player 2 ";
//    wcin >> player2;
...
//    if (toss == 0)
//    {
//        wcout << "\t\t   PLAYER 1 WON  " << player1 << " its your turn \n";
//    }
//    else
//    {
//        wcout << "\t\t   PLAYER 2 WON  " << player2<< " its your turn \n";
//    }
//    system("pause");
...
//    bool check;
    ...
    //if (!check)
//    //{
//    //    wcout << "\r INVALID MOVE ; PLEASE TRY AGAIN " << endl << endl;
//    //    player1turn = !player1turn; // Prevents skipping turns due to an invalid move
//    //}
//    return;
//}
...
//  //  drawBoard();
//
//    wstring player1 = L"Player 1 (White)";
//    wstring player2 = L"Player 2 (Black)";
//    bool is_game_over = false;
//
//    do
//    {
//        if (player1turn)
//            playermove(player1, is_game_over);
//        else
//            playermove(player2, is_game_over);
//        player1turn = !player1turn;
//    } while (!is_game_over);
//
//    system("pause");
...
//using namespace std;
//
//// Simulated chessboard (basic representation)
//void drawBoard() {
//    cout << setw(60) << "  a   b   c   d   e   f   g   h  " << endl;
//    for (int i = 8; i >= 1; i--) {
//        cout << setw(50) << i << " | ♜ | ♞ | ♝ | ♛ | ♚ | ♝ | ♞ | ♜ | " << endl;
//    }
//}
//
//// Toss function
//void tossPlayers(string player1, string player2) {
//    srand(time(0));
//    int toss = rand() % 2;
//
//    string whitePlayer = toss ? player1 : player2;
//    string blackPlayer = toss ? player2 : player1;
//
//    // Print Toss Result on Left, Board on Right
//    cout << "\n" << left << setw(30) << "===== Tossing Coin =====" << setw(40) << "===== Chess Board =====" << endl;
//
//    // Print Player Names
//    cout << left << setw(30) << "Toss Result:" << setw(40) << "" << endl;
//    cout << left << setw(30) << "White: " + whitePlayer << setw(40) << "" << endl;
//    cout << left << setw(30) << "Black: " + blackPlayer;
//
//    // Draw board on the right side
//    drawBoard();
//}
//
//int main() {
...
//    cin >> player2;
//
//    system("cls");  // Clear screen before showing the toss
//    tossPlayers(player1, player2);
//    system("pause");
//    return 0;
//}
//#include <iostream>
...
//
//int main() {
//    // Clear the screen (Windows-specific; remove or replace if not on Windows)
//    system("cls");
//
//    // Left column: ASCII "CHESS" title, your name, instructions, etc.
//    // Feel free to replace these lines with your own ASCII art or text.
...
//        "",
//        " Instructions:",
//        "  1. Here is some placeholder text.",
//        "  2. You can write rules or tips here.",
//        "  3. Press any key to continue...",
//        ""
//    };
//
//    // Right column: ASCII chessboard.
//    // Feel free to replace with your own board-drawing logic/characters.
...
//    };
//
//    // Determine the maximum number of lines we need to print
//    size_t maxLines = std::max(leftColumn.size(), rightColumn.size());
//
//    // Print lines side by side
//    for (size_t i = 0; i < maxLines; ++i) {
//        // Print from left column if we have a line
//        if (i < leftColumn.size()) {
//            std::cout << leftColumn[i];
//        }
//        // Add some spacing between columns (adjust as you wish)
//        std::cout << std::setw(8) << " ";
//
//        // Print from right column if we have a line
//        if (i < rightColumn.size()) {
//            std::cout << rightColumn[i];
//        }
//        // New line
//        std::cout << std::endl;
//    }
...
//
//    // Now you can proceed to your toss/input logic without an empty left side!
//    return 0;
//}
...
//    }
//    wcout << bottomRight << endl;
//    wcout << "\t\t" << L'\u2694' << "  lets Play ..! \t \t\t\t  a   b   c   d   e   f   g   h  \n";
//    wcout << "\t\t\t\t\t\t\t\t" << "Player 1 (" << player1 << ") " << endl;
//}